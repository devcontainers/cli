...
export function featuresTestOptions(y: Argv) {
	return y
		.options({
			...
			'docker-path': { type: 'string', description: 'Optionally provide path the local installation of Docker (or equivalent) CLI' },
			'docker-compose-path': { type: 'string', description: 'Optionally provide path the local installation of docker-compose (or equivalent) CLI' },
		})
