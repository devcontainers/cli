...
export function featuresTestOptions(y: Argv) {
	return y
		.options({
			...
			'skip-idempotency-test': { type: 'boolean', default: false, description: 'Skip all \'idempotency\' style tests (idempotency.sh).' },
...
async function featuresTest({
	...
	'skip-idempotency-test': skipIdempotencyTest,
