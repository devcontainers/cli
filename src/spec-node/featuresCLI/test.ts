...
export function featuresTestOptions(y: Argv) {
	return y
		.options({
			...
			'apply-image-dev-container-metadata': { type: 'boolean', default: true, description: 'Apply image metadata to the resultant image appended by previously building with the devcontainer CLI' },
...
async function featuresTest({
	...
	quiet,
	'apply-image-dev-container-metadata': applyImageMetadata,
