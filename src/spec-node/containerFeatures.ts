...
${getDevcontainerMetadataLabel(getDevcontainerMetadata(imageBuildInfo.metadata, config, { featureSets: [] }, omitPropertyOverride), params.common.experimentalImageMetadata)}
`,
